...
{
	return __be32_to_cpu(AI_ZONE_PTR_FIRST(m_raw));
}

void Inode::SetFirstBlock(uint32_t block) noexcept
{
	AI_ZONE_PTR_FIRST(m_raw) = __cpu_to_be32(block);
}
